...
echo "               ██████╔╝░░░██║░░░███████╗░░╚██╔╝░░███████╗██║░╚███║"
echo "               ╚═════╝░░░░╚═╝░░░╚══════╝░░░╚═╝░░░╚══════╝╚═╝░░╚══╝"
echo -e "	[+]              $red Coded By hacking_702$nc         		   [+]"
echo -e "	[+] 		 $red www.tiktok.com/@wj_v.5$nc 		   [+]"
echo -e "	[+] 		 $red Greetz To All Pentesters$nc          		   [+]"
echo -e "	[+]$red Special Greetz To$nc :$green {thelinuxchoice , hacking_702}$nc [+]"
echo ""
...
echo -e "		$Cyan 5 : Brute Force TikTok Account$nc"
